...
pub(crate) use admission::{
    ...
    record_binary_decision, record_ineligible_self_improvement_source_rejection,
    record_method_decision, record_method_decision_for_action, record_stale_policy_revision,
