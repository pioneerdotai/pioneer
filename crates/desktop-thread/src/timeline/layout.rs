...
mod tests {
    ...
    use pioneer_client::conversation::reducer::TurnPhase;
    use pioneer_client::conversation::reducer::TurnView;
            ...
            TimelineRenderRow::Timeline(TimelineRow {
                ...
                kind: TimelineRowKind::RunningTurn(
                    pioneer_client::timeline::labels::RunningTurnDisplay {
                        turn_id: "turn".to_owned(),
                        started_at_unix_ms: None,
                        state: Some(pioneer_client::timeline::types::TurnWorkState::Running),
                        message: None,
                        route: None,
                        agent_work_graph: None,
                        permission_profile: None,
