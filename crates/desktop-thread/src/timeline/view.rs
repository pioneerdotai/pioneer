...
impl ThreadScreenView {
    pub(crate) fn render_timeline(
        ...
        pioneer_client::timeline::diagnostics::record_qualification_diagnostic!(record_render(
            pioneer_client::timeline::diagnostics::RenderRegion::Timeline
        ));
        ...
        let (grouping, item_sizes, layout_index) = {
                ...
                && let Some(layout_index) = state.cached_timeline_layout_index.as_ref()
            {
                pioneer_client::timeline::diagnostics::record_qualification_diagnostic!(
                    record_timeline(
                        pioneer_client::timeline::diagnostics::TimelineStage::ItemSizesCacheLookup,
                        pioneer_client::timeline::diagnostics::DiagnosticAction::Hit,
                ...
                pioneer_client::timeline::diagnostics::record_desktop_timeline_stage(
                    pioneer_client::timeline::diagnostics::DesktopTimelineStageMetric {
                        stage:
                            pioneer_client::timeline::diagnostics::DesktopTimelineStage::ItemSizes,
                        cache:
                            pioneer_client::timeline::diagnostics::DesktopTimelineCacheStatus::Hit,
                        content:
                            pioneer_client::timeline::diagnostics::DesktopTimelineContentKind::Mixed,
                ...
                pioneer_client::timeline::diagnostics::record_qualification_diagnostic!(
                    record_timeline(
                        pioneer_client::timeline::diagnostics::TimelineStage::ItemSizesCacheLookup,
                        pioneer_client::timeline::diagnostics::DiagnosticAction::Miss,
                        u64::try_from(rows.len()).unwrap_or(u64::MAX),
                    )
                );
                ...
                pioneer_client::timeline::diagnostics::record_qualification_diagnostic!(
                    record_timeline(
                        pioneer_client::timeline::diagnostics::TimelineStage::ItemSizesBuild,
                ...
                pioneer_client::timeline::diagnostics::record_desktop_timeline_stage(
                    pioneer_client::timeline::diagnostics::DesktopTimelineStageMetric {
                        stage:
                            pioneer_client::timeline::diagnostics::DesktopTimelineStage::ItemSizes,
                        cache:
                            pioneer_client::timeline::diagnostics::DesktopTimelineCacheStatus::Miss,
                        content:
                            pioneer_client::timeline::diagnostics::DesktopTimelineContentKind::Mixed,
                        outcome: pioneer_client::timeline::diagnostics::DesktopTimelineOutcome::Ok,
                        elapsed: item_sizes_started.elapsed(),
