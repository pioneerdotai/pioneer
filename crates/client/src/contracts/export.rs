...
pub fn client_contract_types() -> Vec<ClientContractType> {
    ...
    let mut contracts = vec![
        ...
        contract_type!(
            "client_revisions.json",
            crate::core::ClientRevisions,
            Domain::Root,
            Kind::Snapshot,
            Stability::Stable
        ),
        contract_type!(
            "client_generation.json",
            crate::core::ClientGeneration,
            Domain::Root,
            Kind::Snapshot,
            Stability::Stable
        ),
        ...
        contract_type!(
            "client_intent.json",
            crate::core::ClientIntent,
            Domain::Root,
            Kind::Command,
            Stability::Stable
        ),
        contract_type!(
            "client_effect_plan.json",
            crate::core::ClientEffectPlan,
            Domain::Root,
            Kind::Effect,
            Stability::Stable
        ),
