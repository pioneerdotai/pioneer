...
pub(super) const ITEM_TYPE_USER_MESSAGE: &str = "user_message";
pub(super) const ITEM_TYPE_AGENT_MESSAGE: &str = "agent_message";
pub(super) const ITEM_TYPE_REASONING: &str = "reasoning";
pub(super) const ITEM_TYPE_SYSTEM_EVENT: &str = "system_event";
pub(super) const ITEM_TYPE_TASK: &str = "task";
pub(super) const ITEM_TYPE_COMMAND_EXECUTION: &str = "command_execution";
pub(super) const ITEM_TYPE_FILE_CHANGE: &str = "file_change";
pub(super) const ITEM_TYPE_WEB_SEARCH: &str = "web_search";
pub(super) const ITEM_TYPE_WEB_FETCH: &str = "web_fetch";
pub(super) const ITEM_TYPE_DOWNLOAD: &str = "download";
pub(super) const ITEM_TYPE_DYNAMIC_TOOL_CALL: &str = "dynamic_tool_call";

pub(super) trait TurnItemHandler: Send + Sync {
    fn on_started(
        &self,
...
pub(super) struct TurnItemHandlerRegistry {
