use super::*;
use pioneer_client::composer::turn_prepare as client_composer_turn_prepare;
use pioneer_client::transport::ws::command_sender as client_ws_commands;
use pioneer_client::{
...
impl pioneer_client::rpc::JsonRpcRequestTransport for GatewayWsCommandSender {
    fn send_json_rpc_request(
        &self,
        request_id: String,
        payload: String,
        response_tx: pioneer_client::rpc::JsonRpcResponseSender,
        ...
        self.command_tx
            ...
            .map_err(|_| pioneer_client::rpc::WEBSOCKET_WORKER_UNAVAILABLE_MESSAGE.to_owned())
    }
}
...
impl ArtifactDownloadTransport for GatewayWsCommandSender {
    ...
    fn register_artifact_download_chunk(
        ...
        Ok(Box::new(DesktopArtifactDownloadChunkWaiter {
...
impl GatewayWsCommandSender {
    ...
    pub fn send_artifact_upload_chunk(
        ...
        let payload = pioneer_client::transport::ws::frames::encode_artifact_upload_chunk_frame(
            workspace_id,
            upload_id.clone(),
            offset,
            chunk.as_slice(),
    ...
    pub fn send_skill_upload_chunk(
        ...
        let payload = pioneer_client::transport::ws::frames::encode_skill_upload_chunk_frame(
            workspace_id,
            upload_id.clone(),
            offset,
            chunk.as_slice(),
        ...
        P: serde::Serialize,
    {
        ...
        pioneer_client::rpc::deserialize_json_rpc_result(method, result)
    }
    ...
    pub fn request_value(
        ...
        pioneer_client::rpc::send_json_rpc_request_value(self, method, params, timeout)
    }
}

struct DesktopArtifactDownloadChunkWaiter {
    response_rx: Receiver<std::result::Result<ArtifactDownloadChunkPayload, String>>,
}

impl ArtifactDownloadChunkWaiter for DesktopArtifactDownloadChunkWaiter {
    fn recv_timeout(
        &self,
        timeout: Duration,
    ) -> Result<pioneer_client::transport::ws::download::ArtifactDownloadChunkPayload> {
        self.response_rx
