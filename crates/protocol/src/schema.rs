...
use crate::{
    ...
    AgentAuthoredTurnProjection, AgentBoundRuntimeSelection, AgentControlTaskToolInput,
    AgentCreateThreadToolInput, AgentDelegationRouteCreateParams, AgentDelegationRouteId,
    AgentDelegationRouteListParams, AgentDelegationRouteListResponse,
    AgentDelegationRouteProjection, AgentDelegationRouteRevokeParams, AgentDisplayName,
    AgentDurableEvent, AgentExecutionBackend, AgentExecutionId, AgentExecutionProfileBackend,
    AgentExecutionProfileId, AgentExecutionProfileProjection, AgentExecutionProfileSelection,
    AgentExecutionSelection, AgentIdentity, AgentIdentityId, AgentIdentityProjection,
    AgentIdentitySource, AgentIdentitySourceKind, AgentIdentityStatus, AgentLaunchSelection,
    AgentMessagePhase, AgentModelToolCatalogEntry, AgentModelToolName, AgentNicknameKey,
    AgentPresentationSnapshot, AgentProgressEvent, AgentPublicOutcome, AgentResultReturnPolicy,
    AgentResultToolInput, AgentReviewDecision, AgentReviewTaskToolInput, AgentRoleLabel,
    AgentRootDelegationRequest, AgentRouteAction, AgentRouteDisclosurePolicy, AgentRouteGrantId,
    AgentRouteGraphValidationError, AgentRouteKind, AgentRouteStatus, AgentRouteValidationError,
    AgentScheduleTaskToolInput, AgentSendMessageToolInput, AgentStartOptionsProjection,
    AgentStartTarget, AgentStartToolInput, AgentTaskActionSelection, AgentTaskControl,
    AgentTaskReviewProjection, AgentTaskToolInput, AgentThreadAudienceTemplate,
    AgentThreadCreationOption, AgentToolBackendKind, AgentToolCapability, AgentToolIdentityChoice,
    AgentToolIdentityOption, AgentToolLaunchSelection, AgentToolOptionsProjection,
    AgentToolProfileChoice, AgentToolProfileOption, AgentToolResultStatus, AgentToolSafeResult,
    AgentToolTargetOption, AgentToolThreadCreationOption, AgentWaitToolInput,
    AgentWorkGraphProjection, AgentWorkNodeProjection, AgentWorkNodeState, AuthMeResponse,
    AuthorizationAgentPermissionOption, AuthorizationCapabilitiesParams,
    AuthorizationCapabilitySnapshot, AuthorizationChangeKind, AuthorizationChangeScope,
    AuthorizationCliModelGrant, AuthorizationExecutionDraftPolicyProjection,
    ...
    AuthorizationProjectionChangedNotification, AuthorizationProviderModelGrant,
    AuthorizationResourceSelector, AuthorizationRolePresentation, AuthorizationSubjectRef,
    ...
    ChildAgentLaunchGrantSetError, ContextCompressedNotification, ContextCompressingNotification,
    ConversationActorRef, CrossThreadSourceVisibility, DurableEventCausalityKey,
    ...
    GatewaySelfImprovementModelSelection, GatewaySelfImprovementSettings, GatewaySettingsGetParams,
    ...
    McpListItem, McpListParams, McpListResponse, McpManagementDetails, McpPolicySetParams,
    McpPolicySetResponse, McpPolicyState, McpPromptCatalogItem, McpResourceCatalogItem,
    McpResourceTemplateCatalogItem, McpRuntimeState, McpRuntimeStatus, McpScopeKind,
    McpServerCatalogChangedNotification, McpServerCatalogDetails, McpServerDetailsParams,
    McpServerDetailsResponse, McpServerHealthDetails, McpServerPolicy, McpServerRestartParams,
    McpServerRestartResponse, McpServerStatus, McpServerStatusChangedNotification,
    McpServerStatusItem, McpSourceKind, McpToolAnnotationSummary, McpToolCatalogItem,
    McpTransportSummary, McpTurnBindingSummary, McpUninstallParams, McpUninstallResponse,
    McpValidationDiagnostic, MemoryActor, MemoryActorKind, MemoryAttribute,
    MemoryAttributeCardinality, MemoryCandidate, MemoryCandidateCreatedNotification,
    MemoryCandidateDecision, MemoryCandidatePolicyDecision, MemoryCandidatePolicyInput,
    MemoryCandidatePolicyOutput, MemoryCandidateScore, MemoryCandidateScoreBucket,
    MemoryCandidateStatus, MemoryCandidatesApproveParams, MemoryCandidatesApproveResponse,
    ...
    PublicTaskAgendaResponse, PublicTaskAgentConfiguration, PublicTaskArtifact,
    PublicTaskConfiguration, PublicTaskDeliveriesResponse, PublicTaskDelivery,
    ...
    ReasoningCeiling, RoleKey, RuntimeAccountSnapshot, RuntimeAppInfo, RuntimeCapabilities,
    RuntimeDiagnostic, RuntimeDiagnosticLevel, RuntimeModelInfo, RuntimeStatus, RuntimeSummary,
    SafeExecutionProfileMetadata, SafeRouteProvenance, SandboxBackendKind,
    SandboxBackendRequirement, SandboxMode, SandboxPolicy, ServiceId, SkillArchiveFormat,
    SkillAuditTimelineItem, SkillChangedItem, SkillDependencyDiagnostic, SkillHealthItem,
    SkillHealthSummary, SkillHealthTarget, SkillId, SkillInstallState, SkillLifecycleAuditSummary,
    SkillLifecycleRemovedSkill, SkillLifecycleResultSkill, SkillLifecycleSource, SkillListItem,
    SkillListParams, SkillListResponse, SkillPackChangedItem, SkillPackId,
    ...
    SkillsUploadStartParams, SkillsUploadStartResponse, StartAgentIntent, SystemIssuer, Task,
    TaskAcceptParams, TaskAcceptResponse, TaskActorContract, TaskActorContractError,
    ...
    TaskDelivery, TaskDeliveryActorContract, TaskDeliveryAttempt, TaskDeliveryAttemptStatus,
    ...
    TaskDependencyTriggerPolicy, TaskDerivedChildLaunchGrant, TaskDetachParams, TaskDetachResponse,
    ...
    TaskListResponse, TaskManualActor, TaskMetadata, TaskNotificationContext,
    TaskOccurrenceContract, TaskOccurrenceDeliveryPlan, TaskOccurrenceStatus,
    TaskOperatorDeliveries, TaskOperatorDetails, TaskOwnerKind, TaskParentTerminalAction,
    ...
    TaskResultCandidate, TaskResultReviewEvent, TaskResultReviewResolutionStrategy,
    TaskResultReviewerRef, TaskResultReviewerSpec, TaskResumeParams, TaskResumeResponse,
    TaskResumedNotification, TaskRetryBackoffKind, TaskRetryPolicy, TaskReviewerIntent,
    ...
    TaskUpdatedNotification, TaskUserNotification, TaskUserNotificationAcknowledgeParams,
    TaskUserNotificationAcknowledgeResponse, TaskUserNotificationListParams,
    TaskUserNotificationListResponse, TaskValue, TaskWaitItem, TaskWaitParams, TaskWaitResponse,
    ...
    ThreadParticipantsResponse, ThreadPlacement, ThreadReadCursor,
    ThreadReadCursorChangedNotification, ThreadReadParams, ThreadReadResponse,
    ThreadSidebarVisibility, ThreadStartParams, ThreadStartResponse, ThreadStartedNotification,
    ThreadStatus, ThreadTreeChangedNotification, ThreadTreeParams, ThreadTreeResponse,
    ThreadUnreadSummary, ThreadUnsubscribeParams, ThreadUnsubscribeResponse,
    ...
    TurnKind, TurnMcpServerCapabilitySummary, TurnMcpToolCapabilitySummary,
    TurnMessageDeleteParams, TurnMessageDeleteResponse, TurnMessageDeletedEvent,
    TurnMessageEditParams, TurnMessageEditResponse, TurnMessageEditedEvent, TurnMessageErrorReason,
    TurnMessageRevision, TurnMessageRevisionChangeKind, TurnMessageRevisionsPageParams,
    ...
    TurnPermissionApprovalResolution, TurnPermissionAuditDecision, TurnPermissionAuditEvent,
    TurnPermissionAuditEventKind, TurnPermissionAuditRequestKey, TurnPermissionDecisionReason,
    TurnPermissionMode, TurnPermissionProfileCap, TurnPermissionProfileSelection,
    ...
    TurnProcessPolicySnapshot, TurnProcessTimeoutPolicy, TurnReasoningSelection,
    TurnRejectedCapability, TurnResumeParams, TurnResumeResponse, TurnSandboxMode,
...
pub fn protocol_schema_documents() -> Vec<SchemaDocument> {
    vec![
        ...
        schema_doc!("authorization_change_kind.json", AuthorizationChangeKind),
        schema_doc!("authorization_change_scope.json", AuthorizationChangeScope),
        schema_doc!(
            "authorization_projection_changed_notification.json",
        ...
        schema_doc!(
            "authorization_role_presentation.json",
            AuthorizationRolePresentation
        ),
        schema_doc!(
            "authorization_agent_permission_option.json",
            AuthorizationAgentPermissionOption
        ),
        schema_doc!(
            "authorization_invitation_role_option.json",
            AuthorizationInvitationRoleOption
        ),
        schema_doc!(
            "authorization_execution_draft_policy_projection.json",
            AuthorizationExecutionDraftPolicyProjection
        ),
        schema_doc!(
            "authorization_permission_lock.json",
            AuthorizationPermissionLock
        ),
        schema_doc!(
        ...
        schema_doc!(
            "authorization_resource_selector.json",
            AuthorizationResourceSelector
        ),
        schema_doc!(
            "authorization_provider_model_grant.json",
            AuthorizationProviderModelGrant
        ),
        schema_doc!(
            "authorization_cli_model_grant.json",
            AuthorizationCliModelGrant
        ),
        schema_doc!(
            "authorization_operational_resource_projection.json",
            AuthorizationOperationalResourceProjection
        ),
        schema_doc!(
        ...
        schema_doc!("agent_action_id.json", AgentActionId),
        schema_doc!("agent_action_intent.json", AgentActionIntent),
        schema_doc!("agent_action_kind.json", AgentActionKind),
        schema_doc!(
            "agent_action_normalization_error.json",
            AgentActionNormalizationError
        ),
        schema_doc!(
            "agent_bound_runtime_selection.json",
            AgentBoundRuntimeSelection
        ),
        schema_doc!("agent_authored_input.json", AgentAuthoredInput),
        schema_doc!("agent_authored_input_error.json", AgentAuthoredInputError),
        schema_doc!(
            "agent_authored_projection_error.json",
            AgentAuthoredProjectionError
        ),
        schema_doc!(
            "agent_authored_turn_projection.json",
        ...
        schema_doc!(
            ...
            SafeExecutionProfileMetadata
        ),
        schema_doc!("agent_work_graph_projection.json", AgentWorkGraphProjection),
        schema_doc!("agent_work_node_projection.json", AgentWorkNodeProjection),
        schema_doc!("agent_work_node_state.json", AgentWorkNodeState),
        schema_doc!(
            "agent_task_review_projection.json",
            AgentTaskReviewProjection
        ),
        schema_doc!(
            "agent_delegation_route_projection.json",
            AgentDelegationRouteProjection
        ),
        schema_doc!(
            "agent_delegation_route_create_params.json",
            AgentDelegationRouteCreateParams
        ),
        schema_doc!(
            "agent_delegation_route_list_params.json",
            AgentDelegationRouteListParams
        ),
        schema_doc!(
            "agent_delegation_route_list_response.json",
            AgentDelegationRouteListResponse
        ),
        schema_doc!(
            "agent_delegation_route_revoke_params.json",
            AgentDelegationRouteRevokeParams
        ),
        schema_doc!(
            "agent_root_delegation_request.json",
            AgentRootDelegationRequest
        ),
        schema_doc!("agent_route_action.json", AgentRouteAction),
        schema_doc!(
            "agent_route_disclosure_policy.json",
            AgentRouteDisclosurePolicy
        ),
        schema_doc!("agent_result_return_policy.json", AgentResultReturnPolicy),
        schema_doc!("agent_route_kind.json", AgentRouteKind),
        schema_doc!(
            "agent_route_graph_validation_error.json",
            AgentRouteGraphValidationError
        ),
        schema_doc!("agent_route_status.json", AgentRouteStatus),
        schema_doc!(
            "agent_route_validation_error.json",
            AgentRouteValidationError
        ),
        schema_doc!("agent_delegation_route_id.json", AgentDelegationRouteId),
        schema_doc!("agent_route_grant_id.json", AgentRouteGrantId),
        schema_doc!("agent_display_name.json", AgentDisplayName),
        schema_doc!("agent_execution_id.json", AgentExecutionId),
        schema_doc!(
            "agent_execution_profile_backend.json",
            AgentExecutionProfileBackend
        ),
        schema_doc!("agent_execution_profile_id.json", AgentExecutionProfileId),
        schema_doc!(
            "agent_execution_profile_projection.json",
            AgentExecutionProfileProjection
        ),
        schema_doc!(
            "agent_execution_profile_selection.json",
            AgentExecutionProfileSelection
        ),
        schema_doc!("agent_execution_selection.json", AgentExecutionSelection),
        schema_doc!("agent_identity.json", AgentIdentity),
        schema_doc!("agent_identity_id.json", AgentIdentityId),
        schema_doc!("agent_identity_projection.json", AgentIdentityProjection),
        schema_doc!("agent_identity_source.json", AgentIdentitySource),
        schema_doc!("agent_identity_source_kind.json", AgentIdentitySourceKind),
        schema_doc!("agent_identity_status.json", AgentIdentityStatus),
        schema_doc!("agent_launch_selection.json", AgentLaunchSelection),
        schema_doc!(
            "child_agent_launch_grant_set.json",
            ChildAgentLaunchGrantSet
        ),
        schema_doc!(
            "child_agent_launch_grant_set_error.json",
            ChildAgentLaunchGrantSetError
        ),
        schema_doc!("reasoning_ceiling.json", ReasoningCeiling),
        schema_doc!("agent_nickname_key.json", AgentNicknameKey),
        schema_doc!(
            "agent_presentation_snapshot.json",
            AgentPresentationSnapshot
        ),
        schema_doc!("agent_role_label.json", AgentRoleLabel),
        schema_doc!(
            "agent_start_options_projection.json",
            AgentStartOptionsProjection
        ),
        schema_doc!("agent_start_target.json", AgentStartTarget),
        schema_doc!("agent_review_decision.json", AgentReviewDecision),
        schema_doc!("agent_task_action_selection.json", AgentTaskActionSelection),
        schema_doc!("agent_task_control.json", AgentTaskControl),
        schema_doc!(
            "agent_thread_audience_template.json",
            AgentThreadAudienceTemplate
        ),
        schema_doc!(
            "agent_thread_creation_option.json",
            AgentThreadCreationOption
        ),
        schema_doc!("agent_model_tool_name.json", AgentModelToolName),
        schema_doc!(
            "agent_model_tool_catalog_entry.json",
            AgentModelToolCatalogEntry
        ),
        schema_doc!("agent_tool_capability.json", AgentToolCapability),
        schema_doc!("agent_tool_backend_kind.json", AgentToolBackendKind),
        schema_doc!("agent_tool_identity_choice.json", AgentToolIdentityChoice),
        schema_doc!("agent_tool_profile_choice.json", AgentToolProfileChoice),
        schema_doc!("agent_tool_launch_selection.json", AgentToolLaunchSelection),
        schema_doc!("agent_tool_identity_option.json", AgentToolIdentityOption),
        schema_doc!("agent_tool_profile_option.json", AgentToolProfileOption),
        schema_doc!(
            "agent_tool_options_projection.json",
            AgentToolOptionsProjection
        ),
        schema_doc!(
            "agent_send_message_tool_input.json",
            AgentSendMessageToolInput
        ),
        schema_doc!(
            "agent_create_thread_tool_input.json",
            AgentCreateThreadToolInput
        ),
        schema_doc!("agent_start_tool_input.json", AgentStartToolInput),
        schema_doc!("agent_task_tool_input.json", AgentTaskToolInput),
        schema_doc!(
            "agent_schedule_task_tool_input.json",
            AgentScheduleTaskToolInput
        ),
        schema_doc!(
            "agent_tool_thread_creation_option.json",
            AgentToolThreadCreationOption
        ),
        schema_doc!("agent_tool_target_option.json", AgentToolTargetOption),
        schema_doc!(
            "agent_review_task_tool_input.json",
            AgentReviewTaskToolInput
        ),
        schema_doc!(
            "agent_control_task_tool_input.json",
            AgentControlTaskToolInput
        ),
        schema_doc!("agent_wait_tool_input.json", AgentWaitToolInput),
        schema_doc!("agent_result_tool_input.json", AgentResultToolInput),
        schema_doc!("agent_tool_result_status.json", AgentToolResultStatus),
        schema_doc!("agent_public_outcome.json", AgentPublicOutcome),
        schema_doc!("agent_tool_safe_result.json", AgentToolSafeResult),
        schema_doc!("normalized_agent_action.json", NormalizedAgentAction),
        schema_doc!("administrative_actor_ref.json", AdministrativeActorRef),
        schema_doc!("authorization_subject_ref.json", AuthorizationSubjectRef),
        schema_doc!("conversation_actor_ref.json", ConversationActorRef),
        schema_doc!("service_id.json", ServiceId),
        schema_doc!("start_agent_intent.json", StartAgentIntent),
        schema_doc!("system_issuer.json", SystemIssuer),
        ...
        schema_doc!("thread_unread_summary.json", ThreadUnreadSummary),
        ...
        schema_doc!("task_delivery_thread_target.json", TaskDeliveryThreadTarget),
        ...
        schema_doc!("task_composer_work.json", TaskComposerWork),
        ...
        schema_doc!("task_result_reviewer_ref.json", TaskResultReviewerRef),
        schema_doc!("task_agent_review_policy.json", TaskAgentReviewPolicy),
        schema_doc!("task_actor_contract.json", TaskActorContract),
        schema_doc!("task_actor_contract_error.json", TaskActorContractError),
        schema_doc!(
            "task_derived_child_launch_grant.json",
            TaskDerivedChildLaunchGrant
        ),
        schema_doc!(
            "task_delivery_actor_contract.json",
            TaskDeliveryActorContract
        ),
        schema_doc!("task_occurrence_contract.json", TaskOccurrenceContract),
        schema_doc!(
            "task_occurrence_delivery_plan.json",
            TaskOccurrenceDeliveryPlan
        ),
        schema_doc!("task_occurrence_status.json", TaskOccurrenceStatus),
        schema_doc!("task_reviewer_intent.json", TaskReviewerIntent),
        ...
        schema_doc!("public_task.json", PublicTask),
        schema_doc!("public_task_artifact.json", PublicTaskArtifact),
        schema_doc!("public_task_result.json", PublicTaskResult),
        schema_doc!("public_task_failure.json", PublicTaskFailure),
        schema_doc!("public_task_run.json", PublicTaskRun),
        schema_doc!("public_task_trigger.json", PublicTaskTrigger),
        schema_doc!("public_task_dependency.json", PublicTaskDependency),
        schema_doc!("public_task_configuration.json", PublicTaskConfiguration),
        schema_doc!("public_task_delivery_policy.json", PublicTaskDeliveryPolicy),
        schema_doc!(
            "public_task_trigger_configuration.json",
            PublicTaskTriggerConfiguration
        ),
        schema_doc!("public_task_trigger_spec.json", PublicTaskTriggerSpec),
        schema_doc!(
            "public_task_agent_configuration.json",
            PublicTaskAgentConfiguration
        ),
        schema_doc!(
            "public_task_result_contract_configuration.json",
            PublicTaskResultContractConfiguration
        ),
        schema_doc!("task_operator_details.json", TaskOperatorDetails),
        schema_doc!("public_task_get_response.json", PublicTaskGetResponse),
        schema_doc!("task_list_params.json", TaskListParams),
        schema_doc!("task_list_response.json", TaskListResponse),
        schema_doc!("public_task_list_response.json", PublicTaskListResponse),
        schema_doc!("task_tree_params.json", TaskTreeParams),
        schema_doc!("task_tree_response.json", TaskTreeResponse),
        schema_doc!("public_task_tree.json", PublicTaskTree),
        schema_doc!("public_task_tree_response.json", PublicTaskTreeResponse),
        schema_doc!("task_events_params.json", TaskEventsParams),
        schema_doc!("task_events_response.json", TaskEventsResponse),
        schema_doc!("public_task_event.json", PublicTaskEvent),
        schema_doc!("public_task_events_response.json", PublicTaskEventsResponse),
        ...
        schema_doc!("public_task_wait_item.json", PublicTaskWaitItem),
        schema_doc!(
        ...
        schema_doc!(
            ...
            PublicTaskWaitReviewItem
        ),
        schema_doc!(
            "public_task_wait_non_waitable_item.json",
            PublicTaskWaitNonWaitableItem
        ),
        schema_doc!("public_task_wait_response.json", PublicTaskWaitResponse),
        ...
        schema_doc!("public_task_agenda_item.json", PublicTaskAgendaItem),
        schema_doc!("public_task_agenda_response.json", PublicTaskAgendaResponse),
        ...
        schema_doc!("task_user_notification.json", TaskUserNotification),
        schema_doc!(
            "task_user_notification_list_params.json",
            TaskUserNotificationListParams
        ),
        schema_doc!(
            "task_user_notification_list_response.json",
            TaskUserNotificationListResponse
        ),
        schema_doc!(
            "task_user_notification_acknowledge_params.json",
            TaskUserNotificationAcknowledgeParams
        ),
        schema_doc!(
            "task_user_notification_acknowledge_response.json",
            TaskUserNotificationAcknowledgeResponse
        ),
        schema_doc!("public_task_delivery.json", PublicTaskDelivery),
        schema_doc!(
            "public_task_delivery_attempt.json",
            PublicTaskDeliveryAttempt
        ),
        schema_doc!("task_operator_deliveries.json", TaskOperatorDeliveries),
        schema_doc!(
            "public_task_deliveries_response.json",
        ...
        schema_doc!("turn_message_edit_params.json", TurnMessageEditParams),
        schema_doc!("turn_message_edit_response.json", TurnMessageEditResponse),
        schema_doc!("turn_message_delete_params.json", TurnMessageDeleteParams),
        schema_doc!(
            "turn_message_delete_response.json",
            TurnMessageDeleteResponse
        ),
        schema_doc!("turn_message_error_reason.json", TurnMessageErrorReason),
        schema_doc!("turn_message_revision.json", TurnMessageRevision),
        schema_doc!(
            "turn_message_revision_change_kind.json",
            TurnMessageRevisionChangeKind
        ),
        schema_doc!(
        ...
        schema_doc!("turn_message_edited_event.json", TurnMessageEditedEvent),
        schema_doc!("turn_message_deleted_event.json", TurnMessageDeletedEvent),
        schema_doc!("thread_read_params.json", ThreadReadParams),
        schema_doc!("thread_read_cursor.json", ThreadReadCursor),
        schema_doc!("thread_read_response.json", ThreadReadResponse),
        schema_doc!(
            "thread_read_cursor_changed_notification.json",
            ThreadReadCursorChangedNotification
        ),
        ...
        schema_doc!(
            "cli_runtime_thread_binding_management.json",
        ...
        schema_doc!("timeline_reply_summary.json", TimelineReplySummary),
        ...
        schema_doc!(
            "provider_transcription_model_metadata.json",
        ...
        schema_doc!(
            "gateway_thread_episodic_vector_refill_status_changed_notification.json",
            GatewayThreadEpisodicVectorRefillStatusChangedNotification
        ),
        schema_doc!(
        ...
        schema_doc!("gateway_native_agent_config.json", GatewayNativeAgentConfig),
        schema_doc!(
        ...
        schema_doc!(
            "gateway_voice_input_provider.json",
            GatewayVoiceInputProvider
        ),
        schema_doc!(
            "gateway_voice_input_runtime_phase.json",
            GatewayVoiceInputRuntimePhase
        ),
        schema_doc!(
            "gateway_voice_input_runtime_snapshot.json",
            GatewayVoiceInputRuntimeSnapshot
        ),
        schema_doc!(
            "gateway_voice_input_settings.json",
            GatewayVoiceInputSettings
        ),
        schema_doc!(
            "gateway_voice_input_settings_update.json",
            GatewayVoiceInputSettingsUpdate
        ),
        schema_doc!(
            "gateway_voice_input_status_changed_notification.json",
        ...
        schema_doc!("provider_configure_params.json", ProviderConfigureParams),
        schema_doc!(
        ...
        schema_doc!("mcp_management_details.json", McpManagementDetails),
